...
# Usamos los datos ya escalados (datos limpios)
...
# Quitar genes que tienen varianza 0 dentro de alguna clase
# Causa errores al correr el Método Supervisado
y <- trainData$class
...
# Corregir nombres, ya que algunos genes tienen caracteres raros
